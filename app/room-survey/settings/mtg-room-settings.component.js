...
var MeetingSettings = (function () {
    function MeetingSettings(sharedService) {
        ...
        this.mtgRooms = [{ name: 'Albert' }, { name: 'Boardroom' }, { name: 'Brooklyn' }, { name: 'Grosvenor' }, { name: 'Hammersmith' }, { name: 'Helix' }, { name: 'Mathematica' }, { name: 'Millau' }, { name: 'Millenium' }, { name: 'Sydney' }, { name: 'Westminister' }];
    }
    ...
    MeetingSettings.prototype.set = function (i) {
        ...
        this.sharedService.set(this.mtgRooms[i].name);
    };
