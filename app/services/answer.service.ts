...
private answersUrl = 'http://localhost:8095/api/answers';  // URL to web api
private datesQuery = 'http://localhost:8095/api/query-ans';
private finalQueryUrl = 'http://localhost:8095/api/final-query';
